...
<section class="categories-section section-padding" style="background-color: white;">
    <div class="container">
        <h2 class="section-title text-center">Jelajahi Kategori</h2>
        <div class="cat-grid">
            <!-- Example Category 1 -->
            ...
            <!-- Example Category 2 -->
             <a href="<?php echo home_url( '/product-category/tanaman-buah' ); ?>" class="cat-card">
                <img src="https://images.unsplash.com/photo-1591955506264-3f51289048f5?auto=format&fit=crop&w=600&q=80" alt="Tanaman Buah">
                <div class="cat-info">
                    <h3>Tanaman Buah</h3>
            ...
            <!-- Example Category 3 -->
             <a href="<?php echo home_url( '/product-category/outdoor' ); ?>" class="cat-card">
                <img src="https://images.unsplash.com/photo-1558904541-efa843a96f01?auto=format&fit=crop&w=600&q=80" alt="Outdoor">
                <div class="cat-info">
            ...
            <!-- Example Category 4 -->
             <a href="<?php echo home_url( '/product-category/bibit-media' ); ?>" class="cat-card">
                <img src="https://images.unsplash.com/photo-1416879156036-2cd3ec4642ad?auto=format&fit=crop&w=600&q=80" alt="Bibit & Media">
                <div class="cat-info">
                    <h3>Bibit & Media</h3>
...
<section class="about-snippet section-padding" style="background-color: var(--fp-green); color: white;">
    <div class="container grid-2">
        ...
        <div class="about-image" style="display: flex; justify-content: flex-end;">
            <!-- Placeholder -->
